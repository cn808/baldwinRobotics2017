...
public class OI {
    ...
    public JoystickButton cameraToggleBTN;
    public Joystick jS1;
    ...
    public OI() {
        ...
        shiftDownBTN = new JoystickButton(jS1, 3);
        shiftDownBTN.whenPressed(new ShiftDownCMD());
        shiftUpBTN = new JoystickButton(jS1, 4);
        shiftUpBTN.whenPressed(new ShiftUpCMD());
        cameraToggleBTN = new JoystickButton(jS1, 2);
        ...
        SmartDashboard.putData("OperatorDriveCMD", new OperatorDriveCMD());
